...
int button_x = 20;     // X position of the touch button
int button_y = 265;    // Y position of the touch button
...
; // display rotation angle for TFT_eSPI lib  0 = no rotation, 1 = 90dgr, 2 = 180dgr, 3 = 270dgr 
...
void setup() 
{
  ...
  draw_button(-1,-1);
  tft.pushImage(110,5,60,60,LED_rot,TFT_WHITE);
}
...
{  
    ...
    {       
      ...
      if (ledOn)
      {
        tft.pushImage(110,5,60,60,LED_gruen,TFT_WHITE);
      }
      else
      {
        tft.pushImage(110,5,60,60,LED_rot,TFT_WHITE);
